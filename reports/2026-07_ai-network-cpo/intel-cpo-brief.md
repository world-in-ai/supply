...
## TL;DR
- 인텔은 **광 집적(실리콘 포토닉스) 원천기술·자체 팹(Rio Rancho)을 보유·운영** — **외부 고객 대상 SiPh 파운드리 제공은 일부 보도(TrendForce)뿐, 인텔 공식 확인 없음(미확정)**. CPO 제조에선 TSMC·삼성·GF 대비 후발.
...
| **③ 유리기판 + CPO** | 유리기판 위에 광반도체 직접 집적(차세대 패키징) | **시제품(OFC 2026), 상용 '10년 후반(인텔 공식)** ← 최신 |
...
- **❓ SiPh 파운드리(외부 고객)는 미확정**: Rio Rancho에서 외부 고객에 실리콘 포토닉스 제조를 제공한다는 **일부 보도(TrendForce, 2026.05, "reportedly")**가 있으나 — **유리기판 기사 속 부차적 언급이고, 인텔 공식 발표·원문 미확인**. 사실로 단정 금지.
...
- CPO 제조 기준 실질 선두 = **TSMC·삼성·GlobalFoundries**(GF가 팹리스 광기업 실제 양산). 인텔은 **후발** — 원천기술·자체 팹(Rio Rancho)은 보유하나, **외부 CPO/SiPh 수주는 미확정(보도뿐)**, 자사 OCI 완제품은 프로토타입.
- 인텔의 명분 = ①광반도체 원천기술·자체 팹(운영 중), ②미국 대표·지정학(정부 지분·CHIPS·Rio Rancho 허브), ③유리기판 등 차세대 패키징 first-mover.

## 워드용 문구 (확정 — 사실 기반)
> "인텔 : '23년 재정악화로 광모듈 사업 매각 등 광 사업 일부 축소됐으나, 광반도체 원천기술을 기반으로 차세대 CPO(유리기판 등) 개발 지속"
- 매각한 건 **광 트랜시버 완제품 사업(Jabil)**이지 **팹·PIC 기술은 보유·운영**(Rio Rancho).
- 시점을 넣을 경우: **"(유리기판 상용 '10년 후반 목표, 인텔 공식)"** — "'30년 CPO 생산 목표"는 미확인이라 사실로 쓰지 말 것.
