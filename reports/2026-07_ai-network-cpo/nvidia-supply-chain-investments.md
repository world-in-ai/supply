...
|-----------|------|-----------|------------------|
| **Coherent** | 광 부품·레이저·CPO 광엔진 (전략 파트너십) | 지분 + 다년 수십억$ 구매약정 + 캐파/우선접근권, 美 생산라인 증설 지원 | **약 20억$** (2026.03) |
| **Lumentum** | CW 레이저(광원) (전략 파트너십) | 지분 + 구매약정 + 캐파 확보권, 美 신규 팹 지원 | **약 20억$** (2026.03) |
| **Marvell** | 커스텀 XPU·광 DSP·실리콘 포토닉스 (지분) | NVLink Fusion 연계, Celestial AI(Photonic Fabric) 기반 | **약 20억$** (2026.03~04) |
| **Corning** | 광섬유·광 커넥티비티 (광범위 딜) | 美 광섬유 캐파 50%+·커넥티비티 10배 확대, 공장 3곳 | **약 32억$** (광범위 딜 기준, 2026.05) |
| — **합계** — | — | 위 4건 합산 | **약 92억$** |

> 금액 주의:
> - 대형 4건은 지분+구매약정+캐파권이 섞인 패키지 딜의 **총 규모**(순수 지분과 다름). Corning은 "5억$ 주식취득권" 보도와 별개로 **광범위 딜 규모 32억$** 기준으로 표기.
...
> - 합계 **92억$**는 위 4건의 딜 규모를 단순 합산한 값. 언론이 보도한 엔비디아 광통신 **커밋 총액은 "65억$+"**로, Corning을 딜 규모로 잡은 본 표와 산정 기준이 다름.
