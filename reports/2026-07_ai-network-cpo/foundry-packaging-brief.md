...
| **인텔** | IDM | 광 집적 원천기술·자체 팹, 스위치 CPO 철수('23)→OCI로 선회 | OCI 프로토타입·유리기판 **~'30** |
...
- 연산용 광 I/O(OCI): OFC 2024 세계 첫 완전통합 시연(4Tbps·5pJ/bit·PCIe Gen5) → **2년째 프로토타입, 양산·탑재 제품 없음**
- 유리기판+CPO: OFC 2026 시제품, 상용 **~'29~'30**(인텔: "10년 후반") ← 최신 소식
- ※ CPO 제조 파운드리로는 **약체**(GF보다 뒤) — "역량 보유·잠재 참가자". 상세·정정목록은 인텔 브리프 참조
