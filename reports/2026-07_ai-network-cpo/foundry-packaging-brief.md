...
| **GlobalFoundries** | 광반도체 전문 파운드리 | **GF Fotonix**로 Ayar Labs·Lightmatter 등 팹리스 광기업 제조, AMF 인수('25.11) | 제품 양산 중(전문) |
| **인텔** | IDM→파운드리 진입 | 광 집적 원천기술·**Rio Rancho 팹 운영**(SiPh 제조), 스위치 CPO 철수('23) | **'26 SiPh 파운드리 제공 시작**(초기)·자사 OCI는 프로토타입·유리기판 ~'30 |
...
- 트랜시버 '완제품' 사업은 **'23년 Jabil 매각**(≠기술 매각) — **PIC·레이저 기술·팹은 보유·운영**(Rio Rancho)
- **'26년 SiPh 파운드리 진입**: Rio Rancho에서 외부 고객에 실리콘 포토닉스 제조 제공 시작(초기)
- 연산용 광 I/O(OCI) '완제품'은 OFC 2024 시연 후 **프로토타입**(양산·탑재 제품 없음)
- 유리기판+CPO: OFC 2026 시제품, 상용 **~'29~'30**, Rio Rancho 세계 첫 양산 추진 ← 최신
- ※ CPO 제조에선 **후발이나 "초기 진입자"**(규모는 TSMC·GF에 크게 못 미침). 상세·정정목록은 인텔 브리프 참조
