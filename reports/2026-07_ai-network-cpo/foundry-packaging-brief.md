...
## 유리기판(glass substrate) — 자체 vs 협력 → 상세: [`glass-substrate-brief.md`](glass-substrate-brief.md)
- **자체 개발은 Intel만**(챈들러 팹, 프로토타입·상용 '10년 후반~2030s). "Clearwater Forest 유리코어 양산"은 오보(TrendForce·Ian Cutress 반박).
- **TSMC는 자체 아님 → 협력** — Ibiden(ABF 기판)+Innolux(패널) 3사 검증. TSMC 몫은 CoPoS 패키징 통합.
- **삼성전자는 직접 안 함 → 계열사 삼성전기(SEMCO)**가 JV **GLASEM**(+동우화인켐/스미토모)로 진행, **2H27 공급**. 삼성전기는 별도 상장사(≠삼성전자).
- **GF는 유리기판(코어) 미참여** — 유리 도파관(GlassBridge, 광결합)만 Corning 협력.

| 주체 | 성격 | 자체/협력·시점 |
|------|------|-----------|
| **SK 엔펄스(Absolics)** | 기판 전문(SKC) | 선두 — 美 조지아 공장, '26 양산 목표, AMD 샘플 |
| **삼성전기(SEMCO)** | 기판 전문 계열사 | JV(GLASEM, +동우화인켐/스미토모), **2H27 공급**, 2030 양산 확대 |
| **TSMC** | 파운드리 | **협력**(Ibiden·Innolux 3사 검증), CoPoS 파일럿 '27→양산 2H28, 유리코어 상용 2030+ |
| **인텔** | IDM | **자체** R&D, EMIB+유리 샘플('26.1)·CPO 시제품('26), 상용 '10년 후반~2030s(프로토타입) |
