...
| **GlobalFoundries** | 광반도체 전문 파운드리 | **GF Fotonix**로 Ayar Labs·Lightmatter 등 팹리스 광기업 제조, AMF 인수('25.11) → 상세 [`gf-cpo-brief.md`](gf-cpo-brief.md) | **PIC 2018~ 양산 중**(광엔진 SCALE, CPO 양산 '28말~'29 전망) |
